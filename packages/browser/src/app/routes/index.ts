...
export const createOrganizationMemberRoute = createPath<
  OrganizationMemberRoute
>(Path.OrganizationMember);

export const createOrganizationMembersRoute = createPath<
  OrganizationMembersRoute
>(Path.OrganizationMembers);

export const createOrganizationProjectRoute = createPath<
  OrganizationProjectRoute
>(Path.OrganizationProject);

export const createOrganizationProjectsRoute = createPath<
  OrganizationProjectsRoute
>(Path.OrganizationProjects);

export const createOrganizationProjectTaskRoute = createPath<
  OrganizationProjectTaskRoute
